...
// ProviderComponent duplicates the Provider class, but as a pure React component, making it
// possible for providers to accept props.
export default class ProviderComponent extends React.PureComponent {
    constructor(props) {
        super(props);
